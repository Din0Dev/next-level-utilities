...
interface RegexComponentsI {
  title: string;
  description: string;
  regexValue: string;
}

const RegexComponents = (props: RegexComponentsI) => {
  const {
    title = "Title",
  ...
  //! Render
  return (
    <Card className="regex-components" sx={{ minWidth: 275 }}>
      {/* OVERVIEW TITLE */}
      <CardHeader
        className="regex-header"
        action={
          <div>
        ...
        title={
          <Typography
            className="regex-header__title cursor-pointer"
            sx={{ fontSize: 18 }}
      ...
      <CardActions className="regex-actions">
...
export default RegexComponents;
